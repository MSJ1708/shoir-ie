                    ...
                    with col_p2:
                        ...
                        if st.button(f"✅ Approve & Send Code", key=f"approve_{row['id']}_{idx}"):
                            ...
                            if request_type == "Renewal" and existing_local:
                                prior_expiry = existing_local[6]
                                new_expiry = renewed_expiry(prior_expiry, 30, now_dt).isoformat()
                                ...
                                if existing_local:
                                    cursor.execute(
                                        """
                                        UPDATE users
                                        SET password=?, role='User', tier=?, email=?,
                            ...
                            # Keep the richer enterprise profile row and workspace intact.
                            cursor.execute(
