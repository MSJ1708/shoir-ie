...
_MODULE_KEYS = {
    ...
    "Industrial Connectivity Hub": ["conn_df", "enterprise_connector_health_df", "connector_profiles", "erp_connectors"],
    ...
    "Experiment Engine": [
        ...
        "experiment_engine_replication_df", "enterprise_artifact_ledger",
    ],
    ...
    "Capital Investment & Engineering Economics": ["capex_df", "capex_result", "enterprise_artifact_ledger"],
    ...
    "Team Workspaces & RBAC": ["workspace_members_df", "workspace_users", "enterprise_artifact_ledger"],
