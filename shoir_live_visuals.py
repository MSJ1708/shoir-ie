...
_MODULE_KEYS = {
    ...
    "Engineering Model Registry": ["model_registry_df", "model_reproducibility_catalog"],
    ...
    "Control Tower": ["control_tower_metrics", "control_tower_disruption_df", "control_tower_unified_health_df"],
    ...
    "Capital Investment & Engineering Economics": ["capex_df", "capex_result", "fin_cash_flows", "mc_results", "engineering_economics_tco_df"],
    "Engineering Economics & Finance": ["fin_cash_flows", "cvp_products", "mc_results", "engineering_economics_tco_df"],
    "Workforce Engineering": ["work_elements", "balance_result", "skills_df"],
    "Human Factors & Ergonomics (NIOSH)": ["ergonomic_tasks", "time_studies", "mtm_slots", "human_factors_metrics_df"],
    "Industrial Sustainability & LCA": ["sustain_df", "sustain_result", "carbon_sources", "energy_units", "lca_materials", "sustainability_decision_bridge_df"],
    "Green IE & Sustainability": ["carbon_sources", "energy_units", "lca_materials", "sustainability_decision_bridge_df"],
    ...
    "Geospatial Network Designer": ["supply_nodes", "demand_markets", "geospatial_network_routes_df"],
    ...
    "Enterprise Security & Governance": ["security_roles", "enterprise_security_posture_df"],
    "Persistence": ["enterprise_security_posture_df", "shoir_artifact_catalog", "job_history_df"],
